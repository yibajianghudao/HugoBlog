...
lastmod: 2025-12-29T17:15:36+08:00
---
...
└── e34c50e0-dedc-11f0-9b15-68a8282ec412
    ...
    │   └── unit.run
```
在目录中存在以集群fsid命名的目录，内部是该集群在这台主机上运行的daemon的目录，目录中存储着daemon的数据，比如`unit.run`中存储的是daemon的启动命令，这些文件在ceph的[模板单元](../Linux/Systemd.md#模板文件)中被使用,例如:
```
